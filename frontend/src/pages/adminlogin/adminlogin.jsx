      ...
      try {
        ...
        if (success) {
          ...
          localStorage.setItem(
            "user",
            JSON.stringify({ name, email, mobile, isAdmin: true })
          );

          // wait a moment so user sees the toast
          setTimeout(() => navigate("/admin/review-listings"), 1500);
          return;
        }
      } catch (err) {
      ...
      <RightSectionStyled>
        <LoginWrapperStyled>
          ...
          <p className="login-description">
            Admin Portal – Review submitted properties and ensure quality
            control.
          </p>
