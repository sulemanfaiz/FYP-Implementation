      ...
      <AboutUsPageWrapperStyled>
        ...
        <AboutUsPageSectionWrapperStyled>
          <SectionStyled>
            ...
            <div className="desc">
              The Kiraya pa story began with the vision of one man. It was Our
              dream to transform the real estate sector of Pakistan and elevate
              it to bring it at par with the best international standards.
              Having spent 15 years in the UK working in the real estate sector,
              among other achievements Akbar holds to his credit multiple real
              estate mega projects completed internationally as well as in
              Pakistan. Akbar moved back to Pakistan in order to give shape to
              his vision. Thus Kiraya pa was created – the next-generation real
              estate solutions platform for Pakistan. At Kiraya pa, we aim to
          ...
          <SectionStyled>
            ...
            <div className="desc">
              ...
              estate sector is certainly an ambitious one, but Kiraya pa doesn’t
          ...
          <SectionStyled>
            ...
            <div className="desc">
              And so it was 3…2…1…takeoff! Welcome to Kiraya pa.com: a complete
